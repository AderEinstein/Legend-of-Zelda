...
require 'src/states/entity/player/PlayerPotWalkingState'
require 'src/states/entity/player/PlayerLiftOrThrowState'
require 'src/states/entity/player/PlayerIdlePotCarryingState'
...
gTextures = {
    ...
    ['character-potwalk'] = love.graphics.newImage('graphics/character_pot_walk.png'),
    ['character-potlift'] = love.graphics.newImage('graphics/character_pot_lift.png'),
...
gFrames = {
    ...
    ['character-potwalk'] = GenerateQuads(gTextures["character-potwalk"], 16, 32),
    ['character-potlift'] = GenerateQuads(gTextures["character-potlift"], 16, 32),
