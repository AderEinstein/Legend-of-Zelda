...
function Entity:init(def)
    ...
    -- Flag to keep track wether entity just dropped a heart
...
function Entity:createAnimations(animations)
    ...
    for k, animationDef in pairs(animations) do
        animationsReturned[k] = Animation {
            ...
            looping = animationDef.looping and false or true
        }
    end
...
function Entity:changeState(name, def)
    self.stateMachine:change(name, def)
end
